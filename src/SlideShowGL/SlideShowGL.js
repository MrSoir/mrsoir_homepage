...
var FAKE_RANDOMS_CNT = 100;
var VERTEX_COUNT_PER_AXIS = 707;//223;
...
//	layout (location = 6) in vec3 randoms;
	...
	void genRandoms(){
		int tarID = int(mod(float(gl_InstanceID), $!{FAKE_RANDOMS_CNT}!$.0 - 3.0));
...
class SlideShowGL{
	...
	constructor(canvasID, splitDepth=15){		
		...
		this.glMeta = {
			...
			imgRatio: [1,1],
			instancing: true,
			instanceCount: VERTEX_COUNT_PER_AXIS*VERTEX_COUNT_PER_AXIS*2
		};
	...
	createPane(){	
		...
		console.log('VERTEX_COUNT_PER_AXIS: ', VERTEX_COUNT_PER_AXIS);
		this.glFunctions.setUniform1i('vertexCountPerAxis', VERTEX_COUNT_PER_AXIS);
