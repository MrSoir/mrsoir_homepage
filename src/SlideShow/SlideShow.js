	...
	render(){
		...
		let info = 	<p id="SlideShowInfo"
						   ...
						   (e.g. computing rotation matrices using quaternions).
							...
							It only requires a few lines of code to get things going. The above demo is integrated into this
							homepage (created with the awesome React.js-framework) with just 4 lines of code.
							<br/><br/>
							Of course this code is free of any license. You are free to modify this code and use it in your projects/homepages!
							I published the library as a npm-package. You can find detailed instructions on how to install and use SlideShowGL here:
					  	</p>;
