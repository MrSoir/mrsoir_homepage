...
class CarrouselDiaShow extends Component{
  ...
  incrementCentralIds(){
    this.setState({centralImg: (this.state.centralImg + 1) % this.imgs.length});
    this.setState({centralImgPathId: (this.state.centralImgPathId + 1) % this.props.imgPaths.length});  }
  decrementCentralIds(){
