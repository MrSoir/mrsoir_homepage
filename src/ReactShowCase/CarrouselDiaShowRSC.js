  ...
  render() {
    ...
    return (<div id="CarrouselDiaShoMainDivwRSC">
      ...
      <div id="CarrouselDiaShowRSC">
        <CarrouselDiaShow imgPaths={this.generateImagePaths()} autoplay={this.state.autoplay} aspectRatio={[16, 9]}/>
      </div>
